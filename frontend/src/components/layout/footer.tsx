...
export function PrimaryFooter() {
  ...
  return (
    <footer ref={ref} className="bg-background/50 border-t border-border mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-xl font-bold text-primary">BlogAI</h3>
            <p className="text-muted-foreground">
              Transform your content with AI-powered SEO optimization and writing assistance.
            </p>
